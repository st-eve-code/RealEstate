...
function PropertyCardItem({ property }) {
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-lg p-6 font-Custom">
      ...
      <div className="relative rounded-xl h-48 mb-6 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 flex items-center gap-2 bg-white rounded-full px-3 py-1.5 shadow-md">
          ...
          <span className="text-gray-700 font-medium text-sm">{property.likes}</span>
          <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
          <span className="text-gray-700 font-medium text-sm">{property.rating}</span>
        </div>
            ...
            <button
              ...
              className={`rounded-full transition-all ${
                index === currentImageIndex 
                  ...
                  : 'bg-red-300 hover:bg-red-400 w-2.5 h-2.5'
              }`}
            />
          ))}
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700 font-medium">{property.beds} beds</span>
          </div>
          <div className="flex items-center gap-2">
            <Bath className="w-5 h-5 text-red-400" />
            <span className="text-gray-700 font-medium">{property.toilets} toilet</span>
          </div>
          <div className="flex items-center gap-2">
            <UtensilsCrossed className="w-5 h-5 text-red-400" />
            <span className="text-gray-700 font-medium">{property.kitchens} kitchen</span>
          </div>
        </div>
