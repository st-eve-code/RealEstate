...
function Home() {
  ...
  return (
    <section className='w-full mx-auto'>
      <Navbar/>
        <div className='block-animate bg-white border px-1 py-1 my-4 border-gray-300 mx-auto max-w-[20rem] min-w-[10rem] h-10 rounded-full flex items-center justify-between gap-0.5 sm:gap-2'>
          <button className='bg-blue-400 text-white font-Custom font-medium px-1 text-md w-20 flex items-center justify-center h-8 rounded-full shrink-0'>{t('home.new')}</button>
          <p className='font-Custom text-gray-400 font-normal text-xs sm:text-sm truncate pr-[2rem] pl-1'>{t('home.updateRelease')}</p>
        </div>
